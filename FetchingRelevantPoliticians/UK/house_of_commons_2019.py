...
# URL for the 2019 election
url_2019 = "https://en.wikipedia.org/wiki/List_of_MPs_elected_in_the_2019_United_Kingdom_general_election"
...
def save_to_csv(data):
    ...
    file_path = os.path.join("election_data", "mps_2019.csv")
    df.to_csv(file_path, index=False, encoding="utf-8-sig")
    print(f"Data saved to {file_path}.")

def main():
    print("Processing data for 2019...")
    data = fetch_mps_data(url_2019)
    save_to_csv(data)
